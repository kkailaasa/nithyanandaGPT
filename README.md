...
3. Navigate to the `/NithyanandaGPT` directory.
...
9. Open up a web browser and go the address `http://localhost:3000/`.
...
7. I did some tests on the `GGML` and `GGUF` models, it turns out that `GGML` is much faster than `GGUF`.
...
To use this software, you must have Node.js 18 or later installed. Earlier versions of Node.js may not be compatible.
